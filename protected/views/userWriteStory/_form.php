...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'story_story_id'); ?>
		<?php echo $form->textField($model,'story_story_id'); ?>
		<?php echo $form->error($model,'story_story_id'); ?>
	</div>
